...
public class CustomerController {
	...
	public ResponseEntity<UserDto> register(@RequestBody @Valid UserDto userDto, BindingResult result) {
		...
		if(result.hasErrors()) {
			...
			throw new CustomerNotFoundException(ExceptionApi.toErrMsg(result.getAllErrors()));
	...
	public ResponseEntity<LoanOutputDto> applyLoan(@PathVariable("customerId") Long customerId,
